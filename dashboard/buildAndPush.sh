...
docker tag tasarruf-dashboard:latest 177403612005.dkr.ecr.us-east-1.amazonaws.com/tasarruf-dashboard:latest

echo "=== pushing docker image to AWS ECR"

docker push 177403612005.dkr.ecr.us-east-1.amazonaws.com/tasarruf-dashboard:latest
